...
You'll have to set the paths to your locally compiled libraries. Here's how my local [ARMR.pro](https://github.com/brakmic/deeponion/blob/qt-local/ARMR-qt.pro) looks like:
...
Have fun with [ARMR](https://deeponion.org/)! :heart: