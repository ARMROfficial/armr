...
//#ff0026 Armr Color
	...
	*/
    ...
    frameBlocks->setContentsMargins(20,20,20,20);
    ...
    frameBlocksLayout->addStretch(20);
    ...
    // By clicking "Edit configuration file" in "Settings" menu opens ARMR.conf file in the system default editor
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(tr("&About Armr"), this);
    aboutAction->setToolTip(tr("Show information about Armr"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for Armr"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(tr("&Show / Hide"), this);
    encryptWalletAction = new QAction(tr("&Encrypt Wallet..."), this);
    encryptWalletAction->setToolTip(tr("Encrypt or decrypt wallet"));
    encryptWalletAction->setCheckable(true);
    openConfEditorAction = new QAction(tr("Edit configuration &file"), this);
    openConfEditorAction->setToolTip(tr("Edit the configuration file ARMR.conf"));
    backupWalletAction = new QAction(tr("&Backup Wallet..."), this);
    backupWalletAction->setToolTip(tr("Backup wallet to another location"));
    changePassphraseAction = new QAction(tr("&Change Passphrase..."), this);
    changePassphraseAction->setToolTip(tr("Change the passphrase used for wallet encryption"));
    unlockWalletAction = new QAction(tr("&UNLOCK..."), this);
    unlockWalletAction->setToolTip(tr("Unlock wallet"));
    lockWalletAction = new QAction(tr("&LOCK"), this);
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("ARMR client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    case 0: icon = ":/icons/connect_0"; 
			break;
    case 1: icon = ":/icons/connect_1"; 
			break;
    case 2: icon = ":/icons/connect_2"; 
			break;
    case 3: icon = ":/icons/connect_3"; 
			break;
    case 4: icon = ":/icons/connect_4"; 
			break;
    case 5: icon = ":/icons/connect_5"; 
			break;
    case 6: icon = ":/icons/connect_6"; 
			break;
    case 7: icon = ":/icons/connect_7"; 
			break;
    case 8: icon = ":/icons/connect_8"; 
			break;
    default: icon = ":/icons/connect_9"; 
			break;
    }
    labelConnectionsIcon->setPixmap(QIcon(icon).pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ARMR network", "", count));
...
{
    QString strMessage =
//        tr("This transaction is over the size limit.  You can still send it for a fee of %0.5, "
//          "which goes to the nodes that process your transaction and helps to support the network.  "
//          "Do you want to pay the fee?").arg(
            tr("To complete this transaction you will be charged a 0.05% fee of the amount you are sending, "
              "which goes to the nodes that process your transaction and helps to support the network.  "
              "Do you want to pay the fee?").arg(
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Armr address or malformed URI parameters."));
    }
