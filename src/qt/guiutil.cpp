...
void openConfigfile()
{
    ...
    /* Open ARMR.conf with the associated application */
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "ARMR.lnk";
}
...
{
    return GetAutostartDir() / "ARMR.desktop";
}
...
{
    header = tr("ARMR-qt") + " " + tr("version") + " " +
             QString::fromStdString(FormatFullVersion()) + "\n\n" +
             tr("Usage:") + "\n" +
             "  ARMR-qt [" + tr("command-line options") + "]                     " + "\n";
